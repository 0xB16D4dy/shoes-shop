...
export default function Register() {
    ...
    const frm=useFormik({
        ...
        validationSchema:Yup.object().shape({
            ...
            setPassword:Yup.string().oneOf([Yup.ref('password')],'mat khau chua khop').required('setpassword không được bỏ trống !'),
  ...
  return (
    <form className='container d-flex row'onSubmit={frm.handleSubmit}>
        <div className="form-group col-6">
            ...
            <input className='form-control' type='password' id='setPassword' name='setPassword'onChange={frm.handleChange} onBlur={frm.handleBlur} />
        ...
        <div className="form-group col-6">
            ...
            <div className="d-flex align-items-center mt-4">
                <p>Gender</p>
                <input type="radio" name="gender" value={true} className='mx-2'onChange={frm.handleChange} onBlur={frm.handleBlur}/>
                    <label for="">Male</label>
                    {frm.errors.gender ? <span className='text-danger'>{frm.errors.gender}</span>: '' }
                <input type="radio" name="gender" value={false} className='mx-2'onChange={frm.handleChange} onBlur={frm.handleBlur}/>
